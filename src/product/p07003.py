...
from featureparser.parser_com_credit_variables import ParserComCreditVariables
...
class P07003(Generate):
    ...
    def strategy_process(self):
        ...
        try:
            ...
            pcv = ParserComCreditVariables(resp, report_req_no, product_code, query_data_array)
            pcv.process()
