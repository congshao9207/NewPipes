...
class UnionRemarkPortrait:
    ...
    def process(self):
        ...
        transform_class_str(self.income_lst, 'TransURemarkPortrait')
        # self.db.session.bulk_save_objects(self.income_lst)
    ...
    def _remark_detail(self):
        ...
        for i in range(10):
            if i+1 <= income_len:
                ...
                self.income_lst.append(income_temp)
            ...
            if i+1 <= expense_len:
                ...
                self.expense_lst.append(expense_temp)
